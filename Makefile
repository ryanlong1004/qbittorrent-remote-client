...
test-cov: ## Run tests with coverage
	pytest -v --cov=qbittorrent_remote_client --cov-report=term-missing --cov-report=html
...
lint: ## Run all linters
	flake8 .
	pylint qbittorrent_remote_client/
	bandit -r . -ll
...
type-check: ## Run type checking
	mypy qbittorrent_remote_client/ --ignore-missing-imports
